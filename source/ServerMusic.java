...
public class ServerMusic extends JFrame implements Runnable{
    ...
    public class nextsongListener implements ActionListener
    {
	    ...
	    if(empty(artistField.getText()) || artistField.getText.equals("NotValid")){
		artistField.setText("Not Valid");
		return;
	    }
	    if(empty(albumField.getText()) || albumField.getText.equals("NotValid")){
		albumField.setText("Not Valid");
		return;
	    }
	    if(empty(songtitleField.getText()) || songtitleField.getText.equals("NotValid")){
		songtitleField.setText("Not Valid");
		return;
	    }
	    if(empty(filepathField.getText()) || filepathField.getText.equals("NotValid")){
		filepathField.setText("Not Valid");
		return;
	    }
	    if(empty(imagepathField.getText()) || imagepathField.getText.equals("NotValid")){
